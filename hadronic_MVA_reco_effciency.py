...
#hist_bbtt_higgspt_pass = TH1F("Hist_higgspt_pass","Hist_higgspt_pass", 14, 300, 1000)
#hist_bbtt_higgspt_fail = TH1F("Hist_Mhiggspt_fail","Hist_higgspt_fail", 14, 300, 1000)
#hist_bbtt_higgspt_total = TH1F("Hist_higgspt_total","Hist_higgspt_total",14, 300, 1000)

#hist_bbtt_higgspt_pass_b = TH1F("Hist_higgspt_pass_b","Hist_higgspt_pass_b", 14, 300, 1000)
#hist_bbtt_higgspt_fail_b = TH1F("Hist_higgspt_fail_b","Hist_higgspt_fail_b", 114, 300, 1000)
#hist_bbtt_higgspt_total_b = TH1F("Hist_higgspt_total_b","Hist_higgspt_total_b",14, 300, 1000)
...
for x in range(nEntries):
	...
	if(bcount==1 and tree_bbtt.nTau==2): #Selecting events for hadronic channel
		events_selected=events_selected+1
		cutflow_1000.AddBinContent(1)
		pt_total = tree_bbtt.Tau_pt[0] + tree_bbtt.Tau_pt[1]
		eta_total = tree_bbtt.Tau_eta[0] + tree_bbtt.Tau_eta[1]
		phi_total = tree_bbtt.Tau_phi[0] + tree_bbtt.Tau_phi[1]
		mass_total = tree_bbtt.Tau_mass[0] + tree_bbtt.Tau_mass[1]
		Tau_v1.SetPtEtaPhiM(pt_total,eta_total,phi_total,mass_total)

		####To find the Higgs closest to Tau system######
		for i in range(len(tree_bbtt.GenPart_pt)):
			if (tree_bbtt.GenPart_mass[i]==125.0):
				#print ("Higgs_check",tree_bbtt.GenPart_mass[i])
		...
		if(tree_bbtt.HLT_PFMETNoMu90_PFMHTNoMu90_IDTight==1 or tree_bbtt.HLT_PFMETNoMu110_PFMHTNoMu110_IDTight==1 or tree_bbtt.HLT_PFMETNoMu120_PFMHTNoMu120_IDTight==1 or tree_bbtt.HLT_MonoCentralPFJet80_PFMETNoMu120_PFMHTNoMu120_IDTight==1 or tree_bbtt.HLT_PFMET110_PFMHT110_IDTight==1 or tree_bbtt.HLT_PFMET120_PFMHT120_IDTight==1 or  tree_bbtt.HLT_PFMET170_NoiseCleaned==1 or tree_bbtt.HLT_PFMET170_HBHECleaned==1 or tree_bbtt.HLT_PFMET170_HBHE_BeamHaloCleaned==1):
			...
			if(tree_bbtt.Tau_pt[0]>20 and tree_bbtt.Tau_pt[1]>20):
				cutflow_1000.AddBinContent(3)
				if(abs(tree_bbtt.Tau_eta[0])<2.3 and abs(tree_bbtt.Tau_eta[1])<2.3):
					cutflow_1000.AddBinContent(4)
					if(tree_bbtt.Tau_idDecayModeNewDMs[0]==1 and tree_bbtt.Tau_idDecayModeNewDMs[1]==1):
		...
		if((tree_bbtt.HLT_PFMETNoMu90_PFMHTNoMu90_IDTight==1 or tree_bbtt.HLT_PFMETNoMu110_PFMHTNoMu110_IDTight==1 or tree_bbtt.HLT_PFMETNoMu120_PFMHTNoMu120_IDTight==1 or tree_bbtt.HLT_MonoCentralPFJet80_PFMETNoMu120_PFMHTNoMu120_IDTight==1 or tree_bbtt.HLT_PFMET110_PFMHT110_IDTight==1 or tree_bbtt.HLT_PFMET120_PFMHT120_IDTight==1 or  tree_bbtt.HLT_PFMET170_NoiseCleaned==1 or tree_bbtt.HLT_PFMET170_HBHECleaned==1 or tree_bbtt.HLT_PFMET170_HBHE_BeamHaloCleaned==1) and (tree_bbtt.Tau_pt[0]>20 and tree_bbtt.Tau_pt[1]>20 and abs(tree_bbtt.Tau_eta[0])<2.3 and abs(tree_bbtt.Tau_eta[1])<2.3 and tree_bbtt.Tau_idDecayModeNewDMs[0]==1 and tree_bbtt.Tau_idDecayModeNewDMs[1]==1 and (tree_bbtt.Tau_idMVAoldDM2017v1[0] & tau_id == tau_id))):
			#print ("bitwise_check",tree_bbtt.Tau_idMVAoldDM2017v1[1], tree_bbtt.Tau_idMVAoldDM2017v1[0], tree_bbtt.Tau_idDecayModeNewDMs[1], tree_bbtt.Tau_idDecayModeNewDMs[0])
			pt_total = tree_bbtt.Tau_pt[0] + tree_bbtt.Tau_pt[1]
			eta_total = tree_bbtt.Tau_eta[0] + tree_bbtt.Tau_eta[1]
			phi_total = tree_bbtt.Tau_phi[0] + tree_bbtt.Tau_phi[1]
			mass_total = tree_bbtt.Tau_mass[0] + tree_bbtt.Tau_mass[1]
	...
	#######boosted#############Repeat the procudure for boosted Taus#####################

	if(bcount==1 and tree_bbtt.nboostedTau==2):
		cutflow_1000_b.AddBinContent(1)
		events_selected_b=events_selected_b+1
		pt_total = tree_bbtt.boostedTau_pt[0] + tree_bbtt.boostedTau_pt[1]
		eta_total = tree_bbtt.boostedTau_eta[0] + tree_bbtt.boostedTau_eta[1]
		phi_total = tree_bbtt.boostedTau_phi[0] + tree_bbtt.boostedTau_phi[1]
		mass_total = tree_bbtt.boostedTau_mass[0] + tree_bbtt.boostedTau_mass[1]
		Tau_v1.SetPtEtaPhiM(pt_total,eta_total,phi_total,mass_total)
		...
		if(tree_bbtt.HLT_PFMETNoMu90_PFMHTNoMu90_IDTight==1 or tree_bbtt.HLT_PFMETNoMu110_PFMHTNoMu110_IDTight==1 or tree_bbtt.HLT_PFMETNoMu120_PFMHTNoMu120_IDTight==1 or tree_bbtt.HLT_MonoCentralPFJet80_PFMETNoMu120_PFMHTNoMu120_IDTight==1 or tree_bbtt.HLT_PFMET110_PFMHT110_IDTight==1 or tree_bbtt.HLT_PFMET120_PFMHT120_IDTight==1 or  tree_bbtt.HLT_PFMET170_NoiseCleaned==1 or tree_bbtt.HLT_PFMET170_HBHECleaned==1 or tree_bbtt.HLT_PFMET170_HBHE_BeamHaloCleaned==1):
			...
			if(tree_bbtt.boostedTau_pt[0]>20 and tree_bbtt.boostedTau_pt[1]>20):
				cutflow_1000_b.AddBinContent(3)
				if(abs(tree_bbtt.boostedTau_eta[0])<2.3 and abs(tree_bbtt.boostedTau_eta[1])<2.3):
					cutflow_1000_b.AddBinContent(4)
					if(tree_bbtt.boostedTau_idDecayModeNewDMs[0]==1 and tree_bbtt.boostedTau_idDecayModeNewDMs[1]==1):
						cutflow_1000_b.AddBinContent(5)
						if(tree_bbtt.boostedTau_idMVAoldDM2017v1[0] & tau_id == tau_id):
							cutflow_1000_b.AddBinContent(6)
		

		if((tree_bbtt.HLT_PFMETNoMu90_PFMHTNoMu90_IDTight==1 or tree_bbtt.HLT_PFMETNoMu110_PFMHTNoMu110_IDTight==1 or tree_bbtt.HLT_PFMETNoMu120_PFMHTNoMu120_IDTight==1 or tree_bbtt.HLT_MonoCentralPFJet80_PFMETNoMu120_PFMHTNoMu120_IDTight==1 or tree_bbtt.HLT_PFMET110_PFMHT110_IDTight==1 or tree_bbtt.HLT_PFMET120_PFMHT120_IDTight==1 or  tree_bbtt.HLT_PFMET170_NoiseCleaned==1 or tree_bbtt.HLT_PFMET170_HBHECleaned==1 or tree_bbtt.HLT_PFMET170_HBHE_BeamHaloCleaned==1) and (tree_bbtt.boostedTau_pt[0]>20 and tree_bbtt.boostedTau_pt[1]>20 and abs(tree_bbtt.boostedTau_eta[0])<2.3 and abs(tree_bbtt.boostedTau_eta[1])<2.3 and tree_bbtt.boostedTau_idDecayModeNewDMs[0]==1 and tree_bbtt.boostedTau_idDecayModeNewDMs[1]==1 and (tree_bbtt.boostedTau_idMVAoldDM2017v1[0] & tau_id == tau_id))):
			#print ("bitwise_check",tree_bbtt.boostedTau_idMVAoldDM2017v1[1] & tau_id, tree_bbtt.boostedTau_idMVAoldDM2017v1[0] & tau_id, tree_bbtt.boostedTau_idDecayModeNewDMs[0], tree_bbtt.boostedTau_idDecayModeNewDMs[1])
			pt_total = tree_bbtt.boostedTau_pt[0] + tree_bbtt.boostedTau_pt[1]
			eta_total = tree_bbtt.boostedTau_eta[0] + tree_bbtt.boostedTau_eta[1]
			phi_total = tree_bbtt.boostedTau_phi[0] + tree_bbtt.boostedTau_phi[1]
			mass_total = tree_bbtt.boostedTau_mass[0] + tree_bbtt.boostedTau_mass[1]
...
#hist_bbtt_higgspt_pass_2000 = TH1F("Hist_higgspt_pass_2000","Hist_higgspt_pass_2000", 14, 300, 1000)
#hist_bbtt_higgspt_fail_2000 = TH1F("Hist_Mhiggspt_fail_2000","Hist_higgspt_fail_2000", 14, 300, 1000)
#hist_bbtt_higgspt_total_2000 = TH1F("Hist_higgspt_total_2000","Hist_higgspt_total_2000",14, 300, 1000)

#hist_bbtt_higgspt_pass_2000_b = TH1F("Hist_higgspt_pass_2000_b","Hist_higgspt_pass_2000_b", 14, 300, 1000)
#hist_bbtt_higgspt_fail_2000_b = TH1F("Hist_higgspt_fail_2000_b","Hist_higgspt_2000_fail_b", 14, 300, 1000)
#hist_bbtt_higgspt_total_2000_b = TH1F("Hist_higgspt_total_2000_b","Hist_higgspt_total_2000_b",14, 300, 1000)
...
for x in range(nEntries):
	...
	if(bcount==1 and tree_bbtt.nTau==2):
		events_selected=events_selected+1
...
#hist_bbtt_higgspt_pass_4000 = TH1F("Hist_higgspt_pass_4000","Hist_higgspt_pass_4000", 14, 300, 1000)
#hist_bbtt_higgspt_fail_4000 = TH1F("Hist_Mhiggspt_fail_4000","Hist_higgspt_fail_4000", 14, 300, 1000)
#hist_bbtt_higgspt_total_4000 = TH1F("Hist_higgspt_total_4000","Hist_higgspt_total_4000",14, 300, 1000)

#hist_bbtt_higgspt_pass_4000_b = TH1F("Hist_higgspt_pass_4000_b","Hist_higgspt_pass_4000_b", 14, 300, 1000)
#hist_bbtt_higgspt_fail_4000_b = TH1F("Hist_higgspt_fail_4000_b","Hist_higgspt_4000_fail_b", 14, 300, 1000)
#hist_bbtt_higgspt_total_4000_b = TH1F("Hist_higgspt_total_4000_b","Hist_higgspt_total_4000_b",14, 300, 1000)
...
legend2.SetHeader("#tau_{h}-#tau_{h} channels","C")
...
legend3.SetHeader("#tau_{h}-#tau_{h} channels","C")
...
legend4.SetHeader("#tau_{h}-#tau_{h} channels","C")
...
legend5.SetHeader("#tau_{h}-#tau_{h} channels","C")
...
legend6.SetHeader("#tau_{h}-#tau_{h} channels","C")
